...
const Cart = () => {
  ...
  return (
    <div className="m-10">
      ...
      <div className="flex">
        <div className="border border-black p-5 flex flex-col rounded-md gap-5 w-1/2">
          {cartData.length !== 0 ? (
            <button
              className="bg-red-400 w-32 p-2 rounded-md"
        ...
        <div className="w-1/2 ">
          <div className="w-[400] p-3 px-6 rounded border border-black m-auto">
            ...
            <div className="mb-2">
              ...
              />
              <button
                className="bg-sky-300 px-2 rounded"
                onClick={() => getDiscount(couponCode.current.value)}
              >
                Apply
              </button>
              <ul className="flex gap-2 my-2">
                <li className="border-2 border-black rounded px-2 bg-zinc-300">
                  FREE
                </li>
                <li className="border-2 border-black rounded px-2 bg-zinc-300">
                  FLAT50
            ...
            <div className="flex justify-between">
              <p>To pay:</p>
              <span>
                {(itemTotal + deliveryFee).toFixed(2) - discountedAmount}
              </span>
            </div>
